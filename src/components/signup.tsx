            ...
            <div className="w-full max-w-md p-8 bg-yellow-500 rounded-lg shadow-lg">
                ...
                <form onSubmit={handleSubmit}>
                    ...
                    <div className="mb-4">
                        ...
                        <input className="w-full p-3 rounded bg-black text-white border border-yellow-300 focus:outline-none focus:ring-2 focus:ring-yellow-400" type="text" id="name" name="name" required onChange={(e:any)=>{
                    ...
                    <button className="w-full py-3 bg-black text-yellow-500 rounded hover:bg-yellow-600 transition-colors" type="submit">Sign Up</button>
                </form>
                <span>{error}</span>
